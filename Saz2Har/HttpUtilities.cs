...
internal static  class HttpUtilities
{
    ...
    public static readonly byte[] IdentityContentEncodingAsciiBytes = Encoding.ASCII.GetBytes("identity");
    public static readonly byte[] GZzipContentEncodingAsciiBytes = Encoding.ASCII.GetBytes("gzip");
    public static readonly byte[] DeflateContentEncodingAsciiBytes = Encoding.ASCII.GetBytes("deflate");
    public static readonly byte[] BrotliContentEncodingAsciiBytes = Encoding.ASCII.GetBytes("br");
